  ...
  sidebarLayout(
    ...
    mainPanel(
        tabsetPanel(type = "pills", 
                    ...
                    tabPanel("Details", h3("Details of the algorithm:"),
                             h4("- Record the 4-, 3-, 2-, 1-grams and their counts using the randomly sampled 10% of texts."),
                             ...
                             em("source code: "),
                             HTML("https://github.com/zhangx306/Coursera_DSCapstone"))
